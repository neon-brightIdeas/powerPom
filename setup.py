...
if platform == "linux" or platform == "linux2":
    ...
    subprocess.check_call([sys.executable, "-m", "pip", "install", "-r", "./Tools/requirements_linux.txt"])
    ...
    subprocess.check_call([sys.executable, "-m", "pip", "install", "-r", "./Tools/requirements_windows.txt"])
